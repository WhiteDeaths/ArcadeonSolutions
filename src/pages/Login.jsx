...
export default function Login() {
  ...
  <div style={{ background: "#222", border: "2px solid #03fc62", borderRadius: "16px", boxShadow: "0 2px 12px rgba(3,252,98,0.18)", padding: "2.5rem 2rem", width: "370px", color: "#fff", textAlign: "center", position: "relative", display: "flex", flexDirection: "column", alignItems: "center" }}>
        ...
        <div style={{ width: "92%", display: "flex", flexDirection: "column", gap: "1.1rem" }}>
          <input type="email" value={email} onChange={e => setEmail(e.target.value)} placeholder="Email" style={{ width: "100%", padding: "0.95rem", borderRadius: "10px", border: "1.5px solid #03fc62", fontSize: "1.08rem", background: "#181818", color: "#fff" }} />
          <input type="password" value={password} onChange={e => setPassword(e.target.value)} placeholder="Password" style={{ width: "100%", padding: "0.95rem", borderRadius: "10px", border: "1.5px solid #03fc62", fontSize: "1.08rem", background: "#181818", color: "#fff" }} />
          <input type="text" value={token} onChange={e => setToken(e.target.value)} placeholder="2FA Code" style={{ width: "100%", padding: "0.95rem", borderRadius: "10px", border: "1.5px solid #03fc62", fontSize: "1.08rem", background: "#181818", color: "#fff" }} />
        </div>
